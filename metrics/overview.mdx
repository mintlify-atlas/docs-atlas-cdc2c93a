...
<Note>
  VERSA acknowledges all open-source implementations listed in the [official metrics documentation](https://github.com/wavlab-speech/versa/tree/main#list-of-metrics).
</Note>
